...
$router->add('/public/department/update', array(
    'controller' => 'DepartmentController',
    'action' => 'updateDepartment'
));

$router->add('/public/department/delete', array(
    'controller' => 'DepartmentController',
...
$router->add('/public/product/update', array(
    'controller' => 'ProductController',
    'action' => 'updateProduct'
));

$router->add('/public/product/delete', array(
    'controller' => 'ProductController',
...
$router->add('/public/productcategory/update', array(
    'controller' => 'ProductCategoryController',
    'action' => 'updateProductCategory'
));

$router->add('/public/productcategory/delete', array(
    'controller' => 'ProductCategoryController',
...
$router->add('/public/movementType/update', array(
    'controller' => 'MovementTypeController',
    'action' => 'updateMovementType'
));

$router->add('/public/movementType/delete', array(
    'controller' => 'MovementTypeController',
